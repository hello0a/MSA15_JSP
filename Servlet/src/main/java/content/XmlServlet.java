...
public class XmlServlet extends HttpServlet {
	...
	protected void doPost(
		...
		// ** 포인트!!
		// setContentType : application/xml, text/html, application/json,text/plain
		...
		try {
			...
			Marshaller marsharller = context.createMarshaller();
			// XML 태그들을 포맷팅하는 옵션 지정 (들여쓰기 등)
			marsharller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, true);
			StringWriter stringWriter = new StringWriter();
			
			// 객체 --> xml 로 변환
			marsharller.marshal(wrapper, stringWriter);
