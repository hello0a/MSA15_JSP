...
public class MethodServlet extends HttpServlet {
	...
	protected void doGet(
		...
		try {
			...
			// age = null -> null 인 값 정수로 바꾸기 불가능 -> 파라미터가 올바르지 않습니다 오류 발생
	 ...
	 * <form> 요청으로 인식하고, request.getParameteer() 를 호출하면 
	...
	//com.fasterxml.jackson.annotation.JsonView 오류 발생!!!
	// 어노테이션 없음..!! 라이브러리 받아오기!!
	// Jackson Annotations » 2.20 다운로드
